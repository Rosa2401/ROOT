    ...
    return (
      <div>
        <HeroSectionSVG
                        ...
                        description="Vi står klar til at hjælpe dig med at skabe en løsning, 
                        der både fungerer og ser godt ud. Fortæl os om dit projekt, 
                        så finder vi den bedste vej frem sammen."
        />    
